...
def main( args ):
    ...
    # lakes_4326.plot( ax=base )
    # residences_4326[res_mask==True].plot( ax=base, markersize=1, color='red' )
    # residences_4326[res_mask==False].plot( ax=base, markersize=1, color='black' )
    # boxes_4326.plot(ax=base, color="none", edgecolor="red", linewidth=1)
