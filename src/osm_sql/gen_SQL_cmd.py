""" This script is used to generate the SQL queries to re-organize OSM tables,
    by selecting specific geo-features for each geometry type (points, lines, polygons)

    Edited by Suzie Hoops for the final project : MN lake assessments
"""

f = open('code/osm.sql', 'w') # originally: 'sample_code/osm.sql'

# originally: "highway", "waterway", "aerialway", "man_made"
LINE_FEATURES = ["highway", "water", "waterway", "man_made"] # editted for mn lakes
LINE_TABLE_NAME = "lines"
NEW_LINE_TABLE_NAME = "line_features"

# originally: "highway"
POINT_FEATURES = ["highway"] # editted for mn lakes
POINT_TABLE_NAME = "points"
NEW_POINT_TABLE_NAME = "point_features"

# originally: "aeroway", "amenity", "building", "landuse", "natural", "tourism"
POLYGON_TABLE_NAME = "multipolygons"
POLYGON_FEATURES = ["amenity", "building", "geological", "landuse", "natural", "tourism", "water"] # editted for mn lakes
